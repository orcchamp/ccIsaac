...
namespace CrowdControl.Games.Packs
{
	...
	public class BindingOfIsaacAfterbirthPlus : SimpleTCPPack
	{
		...
		public override List<Effect> Effects => new List<Effect> {
			...
			new Effect("Invisibility", "invulnerable_timed", "timed_effects") {Price = 50, Description = "You can't see me (Lasts 30 seconds)"},
			...
			new Effect("Invulnerability", "invisble_timed", "timed_effects") {Price = 50, Description = "I AM INVINCIBLE!(Lasts 30 seconds)"},
			...
			new Effect("Use Jera Rune", "use_jera_rune", "pocket_items") {Price = 25, Description = "Undoes Curses"},
			...
			new Effect("Use Suicide King", "use_suicide_king_card", "pocket_items") {Price = 1000, Description = "Kills the streamer but spawns items if they're still alive after"},
